...
ANSWER_KEY_WORKBOOK = xlrd.open_workbook(
    os.path.join(TEST_DIR, 'risk-answer-key.xlsx'))

ANSWER_KEY_SIM_SHEET = ANSWER_KEY_WORKBOOK.sheet_by_name('Sim')

RETURNS = [round(x.value, 4)
           for x in ANSWER_KEY_SIM_SHEET.col_slice(3, 3, 254)]
